import { FieldInfo, getFileElementName } from '@renderer/entity/form.entity'
import { SearchFormDef, SearchAndOr, SearchField } from '@renderer/entity/search.entity'
import { Button, Form, Space, message } from 'antd'
import SearchItem, { SearchItemInfo } from './search_bar_item'
import { useMemo, useState } from 'react'
import { DownOutlined } from '@ant-design/icons'
import { getValidErrMsg } from '@renderer/libs/tools/valid'
import { OperateCode } from '@renderer/entity/operate.entity'
            ...
            return (
              ...
              <Space size={[8, 16]} wrap>
                {fields.map((field) => {
                  return (
                    <div
                      className="flex mr-3 border-red-500 border-[1px] border-dashed"
                      key={field.name}
                    >
