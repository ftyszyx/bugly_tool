import {
  ...
  SearchAndOr,
  SearchOpKey
} from '@renderer/entity/search.entity'
import { FieldInfo } from '@renderer/entity/form.entity'
  ...
  return (
    <div className="[&>div]:mb-0  [&>div]:mr-2 flex flex-row items-start">
      ...
      {fieldItem && (
        <Form.Item
          label=""
          name={[props.parent_index, 'value']}
          rules={fieldItem.search_rules || [{ required: true }]}
        >
